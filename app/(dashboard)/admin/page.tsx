...
export default function AdminPage() {
  ...
  const menu = [
    { title: "Cadastrar aluno", href: "/admin/cadastrar-aluno", icon: UserPlus },
    { title: "Ver alunos", href: "/admin/alunos", icon: Users },
    { title: "Criar treino", href: "/admin/criar-treino", icon: Dumbbell },
    { title: "Ver treinos", href: "/admin/ver-treinos", icon: Dumbbell },
    { title: "Treinos concluídos", href: "/admin/treinos-concluidos", icon: CheckCircle },
    { title: "Presenças", href: "/admin/presencas", icon: CalendarCheck },
    { title: "Ranking", href: "/admin/ranking", icon: Trophy },
    { title: "Evolução física", href: "/admin/evolucao", icon: ChartColumn },
    { title: "Antes e Depois", href: "/admin/evolucao/fotos", icon: Camera },
    { title: "Chat alunos", href: "/admin/chat", icon: MessageCircle },
    { title: "Planos", href: "/admin/planos", icon: Crown },
    { title: "Financeiro", href: "/admin/financeiro", icon: Wallet },
  ];

  const cards = [
    { title: "Alunos ativos", value: alunosAtivos, icon: Users },
    { title: "Presenças hoje", value: presencasHoje.length, icon: CalendarCheck },
    { title: "Receita total", value: `R$ ${receitaTotal}`, icon: Wallet },
    { title: "Receita online", value: `R$ ${receitaOnline}`, icon: Wallet },
    { title: "Pagamentos atrasados", value: pagamentosAtrasados, icon: AlertTriangle },
    { title: "Treinos cadastrados", value: treinosCadastrados, icon: Dumbbell },
  ];
              ...
              {menu.map((item) => {
                ...
                return (
                  <Link
                    ...
                    href={item.href}
                    onClick={() => setMenuAberto(false)}
                    className="flex items-center gap-4 rounded-3xl p-4 font-bold bg-zinc-900 border border-zinc-800 hover:border-yellow-400 transition"
                  >
          ...
          <div className="space-y-4">
            ...
            {presencasHoje.map((presenca) => (
              ...
              >
                ...
                <p className="text-yellow-400 font-bold mt-2">{presenca.treino}</p>
                <p className="text-gray-500 text-sm mt-2">ID: {presenca.aluno_id}</p>
